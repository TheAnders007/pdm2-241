...
class Aluno {
  ...
  Aluno({this.id = -1, required this.nome, required this.dataNascimento});
...
class AlunoDatabase {
  ...
  Future<Database> get database async {
    ...
    // Inicializa o banco de dados se ainda não foi feito
  ...
  // Verificando se os campos existem e têm os tipos corretos
   if (alunoMap.containsKey('id') &&
    ...
    // Retornar um Aluno vazio caso os dados estejam incorretos
    return Aluno(id: -1, nome: '', dataNascimento: '');
  }
}
